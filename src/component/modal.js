        ...
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none   mx-6">
                {/*header*/}
                ...
                <div className="relative">
                  <p className="text-slate-500 text-lg list-outside">
                    <ul className="list-outside"><li>Code:{item.code}</li>
